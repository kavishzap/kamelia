...
const iconWrap =
  "inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/15 text-[#c9a962] transition hover:border-[#c9a962]/50 hover:bg-[#c9a962]/10 hover:text-[#e8d9b4]";
...
export function SocialIcons({ className = "", onNavigate }: Props) {
  return (
